    ...
    return function (t) {
        ...
        function r(t) {
            for (var e = 0, n = 0; n < t.length; n++) {
                ...
                if (o < 128) e += 1; else if (o < 2048) e += 2; else if (o < 55296) e += 3; else {
        ...
        var o, r = function () {
            ...
            return t.prototype.create = function (t) {
                this.lastId++;
                var e = this.lastId, n = this.prefix + e, o = this.name + "[" + e + "]", r = !1, i = function () {
        ...
        }(), i = new r("_pusher_script_", "Pusher.ScriptReceivers"), s = {
            VERSION: "7.0.3",
            PROTOCOL: 7,
            wsPort: 80,
            wssPort: 443,
            ...
            return t.prototype.load = function (t, e, n) {
                var o = this;
                if (o.loading[t] && o.loading[t].length > 0) o.loading[t].push(n); else {
                    o.loading[t] = [n];
                    var r = _e.createScriptRequest(o.getPath(t, e)), i = o.receivers.create((function (e) {
        ...
        }(), a = new r("_pusher_dependencies", "Pusher.DependenciesReceivers"), u = new c({
            cdn_http: s.cdn_http,
            ...
            function e(e) {
                var n = this.constructor, o = t.call(this, e) || this;
            ...
            function e(e, n) {
                var o = this.constructor, r = t.call(this, n) || this;
                return r.status = e, Object.setPrototypeOf(r, o.prototype), r
            }

            return l(e, t), e
        }(Error), _ = function (t, e, n) {
            var o, r = this;
            ...
            return o.onreadystatechange = function () {
                if (4 === o.readyState) if (200 === o.status) {
                    ...
                    n(new w(o.status, "Unable to retrieve auth string from auth endpoint - received status: " + o.status + " from " + r.options.authEndpoint + ". Clients must be authenticated to join private or presence channels. " + i), {auth: ""})
                }
                ...
                return JSON.stringify((e = [], n = [], function t(o, r) {
                    ...
                    switch (typeof o) {
                        case"object":
                            ...
                            if (e.push(o), n.push(r), "[object Array]" === Object.prototype.toString.apply(o)) for (c = [], i = 0; i < o.length; i += 1) c[i] = t(o[i], r + "[" + i + "]"); else for (s in c = {}, o) Object.prototype.hasOwnProperty.call(o, s) && (c[s] = t(o[s], r + "[" + JSON.stringify(s) + "]"));
                            return c;
                        case"number":
                        case"string":
                        case"boolean":
        ...
        var $ = new (function () {
            ...
            return t.prototype.debug = function () {
                ...
                if (Ie.log) Ie.log(o); else if (Ie.logToConsole) {
                    var r = t.bind(this);
                    r(o)
                }
            }, t
            ...
            var r = t.getDocument(), i = r.createElement("script");
            ...
            return t.prototype.send = function (t) {
                if (!this.request) {
                    var e = V(this.data), n = this.url + "/" + t.number + "?" + e;
            ...
            name: "jsonp", getAgent: function (t, e) {
                return function (n, o) {
                    var r = "http" + (e ? "s" : "") + "://" + (t.host || t.options.host) + t.options.path,
                        s = _e.createJSONPRequest(r, n), c = _e.ScriptReceivers.create((function (e, n) {
        ...
        var ut = function () {
            ...
            return t.prototype.bind = function (t, e, n) {
                ...
                var r = this.callbacks.get(t), i = [];
                if (n ? i.push(e, n) : e && i.push(e), r && r.length > 0) for (o = 0; o < r.length; o++) r[o].fn.apply(r[o].context || window, i); else this.failThrough && this.failThrough(t, e);
                return this
            }, t
        }(), ht = function () {
            var t = function (e, n) {
            ...
            urls: rt, handlesActivityChecks: !1, supportsPing: !1, isInitialized: function () {
            ...
            urls: it, handlesActivityChecks: !1, supportsPing: !0, isInitialized: function () {
                return !0
            }
        }, yt = H({
            getSocket: function (t) {
        ...
        }, bt = {ws: ft, xhr_streaming: new lt(H({}, yt, vt)), xhr_polling: new lt(H({}, gt, vt))}, mt = new lt({
            file: "sockjs",
            urls: st,
        ...
        }, _t = new lt(H({}, yt, wt)), St = new lt(H({}, gt, wt));
        bt.xdr_streaming = _t, bt.xdr_polling = St, bt.sockjs = mt;
        var kt = bt, Ct = function () {
            var t = function (e, n) {
                return (t = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
                    t.__proto__ = e
                } || function (t, e) {
            ...
            return t.prototype.createConnection = function (t, e, n, o) {
                ...
                var i = this.transport.createConnection(t, e, n, o), s = null, c = function () {
                    i.unbind("open", c), i.bind("closed", a), s = M.now()
                }, a = function (t) {
                    if (i.unbind("closed", a), 1002 === t.code || 1003 === t.code) r.manager.reportDeath(); else if (!t.wasClean && s) {
                        var e = M.now() - s;
            ...
            return Lt(e, t), e.prototype.handlesActivityChecks = function () {
                ...
                var e = Et.getCloseAction(t), n = Et.getCloseError(t);
            ...
            return t.prototype.close = function () {
                ...
                this.onMessage = function (e) {
                    ...
                    t.unbindListeners();
                    var n = Et.getCloseAction(e) || "backoff", o = Et.getCloseError(e);
                    t.finish(n, {error: o})
            ...
            return Dt(e, t), e.prototype.authorize = function (t, e) {
                ...
                this.subscribed || (this.subscriptionPending = !0, this.subscriptionCancelled = !1, this.authorize(this.pusher.connection.socket_id, (function (e, n) {
                    e ? (t.subscriptionPending = !1, $.error(e.toString()), t.emit("pusher:subscription_error", Object.assign({}, {
                        type: "AuthError",
                        error: e.message
                    }, e instanceof w ? {status: e.status} : {}))) : t.pusher.send_event("pusher:subscribe", {
                        auth: n.auth,
            ...
            return Ft(e, t), e.prototype.authorize = function (e, n) {
                ...
                if (this.key) if (e.ciphertext && e.nonce) {
                    ...
                    if (o.length < this.nacl.secretbox.overheadLength) $.error("Expected encrypted event ciphertext length to be " + this.nacl.secretbox.overheadLength + ", got: " + o.length); else {
                        var r = Object(Ut.decode)(e.nonce);
                        if (r.length < this.nacl.secretbox.nonceLength) $.error("Expected encrypted event nonce length to be " + this.nacl.secretbox.nonceLength + ", got: " + r.length); else {
                ...
                } else $.error("Unexpected format for encrypted event, expected object with `ciphertext` and `nonce` fields, got: " + e); else $.debug("Received encrypted event before key has been retrieved from the authEndpoint")
            ...
            return Jt(e, t), e.prototype.connect = function () {
                ...
                var t = this, e = function (n, o) {
                    n ? t.runner = t.strategy.connect(0, e) : "error" === o.action ? (t.emit("error", {
                        type: "HandshakeError",
                        error: o.error
                    }), t.timeline.error({handshakeError: o.error})) : (t.abortConnecting(), t.handshakeCallbacks[o.action](o))
                };
        ...
        var Qt = {
            ...
            return t.prototype.isSupported = function () {
                ...
                var n = this, o = this.strategies, r = 0, i = this.timeout, s = null, c = function (a, u) {
                    u ? e(null, u) : (r += 1, n.loop && (r %= o.length), r < o.length ? (i && (i *= 2, n.timeoutLimit && (i = Math.min(i, n.timeoutLimit))), s = n.tryStrategy(o[r], t, {
                        timeout: i,
                        failFast: n.failFast
                    }, c)) : e(!0))
                };
                return s = this.tryStrategy(o[r], t, {timeout: i, failFast: this.failFast}, c), {
                    abort: function () {
                        s.abort()
        ...
        var Zt = function () {
            ...
            return t.prototype.isSupported = function () {
                ...
                var n = this.usingTLS, o = function (t) {
                ...
                if (o && o.timestamp + this.ttl >= M.now()) {
                    ...
                    i && (this.timeline.info({
                        ...
                        latency: o.latency
                    }), r.push(new Yt([i], {timeout: 2 * o.latency + 1e3, failFast: !0})))
                }
                var s = M.now(), c = r.pop().connect(t, (function o(i, a) {
        ...
        var ne = function () {
            ...
            return t.prototype.isSupported = function () {
                ...
                var n, o = this.strategy, r = new I(this.options.delay, (function () {
                    n = o.connect(t, e)
                }));
                return {
                    abort: function () {
        ...
        var se, ce = function (t, e, n) {
            ...
            var i, s = Object.assign({}, e, {
                ...
                p = new Vt({lives: 2, minPingDelay: 1e4, maxPingDelay: t.activityTimeout}), l = r("ws", "ws", 3, s, h),
                f = r("wss", "ws", 3, c, h), d = r("sockjs", "sockjs", 1, a),
                y = r("xhr_streaming", "xhr_streaming", 1, a, p), g = r("xdr_streaming", "xdr_streaming", 1, a, p),
                v = r("xhr_polling", "xhr_polling", 1, a), b = r("xdr_polling", "xdr_polling", 1, a),
                m = new Yt([l], u), w = new Yt([f], u), _ = new Yt([d], u), S = new Yt([new oe(ie(y), y, g)], u),
                k = new Yt([new oe(ie(v), v, b)], u),
                C = new Yt([new oe(ie(S), new $t([S, new ne(k, {delay: 4e3})]), k)], u), T = new oe(ie(C), C, _);
            return i = e.useTLS ? new $t([m, new ne(T, {delay: 2e3})]) : new $t([m, new ne(w, {delay: 2e3}), new ne(T, {delay: 5e3})]), new Zt(new re(new oe(ie(l), i, T)), o, {
                ttl: 18e5,
                timeline: e.timeline,
                useTLS: e.useTLS
            })
        ...
        var Pe = _e.Transports, Oe = function (t, e, n, o, r, i) {
            var s, c = Pe[n];
            if (!c) throw new b(n);
            return !(t.enabledTransports && -1 === B(t.enabledTransports, e) || t.disabledTransports && -1 !== B(t.disabledTransports, e)) ? (r = Object.assign({ignoreNullOrigin: t.ignoreNullOrigin}, r), s = new Ce(e, o, i ? i.getAssistant(c) : c, r)) : s = Ee, s
        }, Ee = {
            isSupported: function () {
                return !1
        ...
        var De = function () {
            ...
            return t.ready = function () {
                ...
                return U(W({ws: _e.Transports.ws}, (function (t) {
                    return t.isSupported({})
                })))
