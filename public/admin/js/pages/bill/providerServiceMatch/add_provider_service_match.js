    ...
    727: function (e, t, r) {
            ...
            init: function () {
                ...
                n = $("#kt_add_form"), (i = new KTWizard("kt_add", {
                    ...
                    t.preventDefault(), o.form() && (KTApp.progress(e), n.ajaxSubmit({
                        url: "/bill-provider-service-match/addAction",
                        method: 'POST',
        ...
        jQuery(document).ready((function () {
            ...
            $("#serviceCode").select2({
                ...
                allowClear: true,
                ajax: {
                    url: "/bill-services/ajax/get-list-source",
                    dataType: 'json',
                    delay: 250,
            ...
            function formatBank(repo) {
                ...
                var markup = "<div class='select2-result-repository clearfix'>" +
                    ...
                    "<div class='select2-result-repository__title'>" + repo.serviceName + "</div>";
                markup += "<div class='select2-result-repository__statistics'>" +
                    "<div class='select2-result-repository__forks'><i class='fa fa-flash'></i> " + repo.serviceCode + "</div></div>";
                return markup;
            }
    
            function formatBankSelection(repo) {
                return repo.serviceCode || repo.text;
            }
        }))
    }
});
