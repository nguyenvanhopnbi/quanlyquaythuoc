            ...
            init: function () {
                ...
                n = $("#kt_add_form"), (i = new KTWizard("kt_add", {
                    ...
                    o.form() && (KTApp.progress(e), n.ajaxSubmit({
                        url: "/gate-partner-bank-vendor/add",
                        method: 'POST',
        ...
        jQuery(document).ready((function () {
            ...
            function formatVendor(repo) {
                ...
                var markup = "<div class='select2-result-repository clearfix'>" +
                    ...
                    "<div class='select2-result-repository__title'>" + repo.vendor_name + "</div>";
                markup += "<div class='select2-result-repository__statistics'>" +
                    "<div class='select2-result-repository__forks'><i class='fa fa-flash'></i> " + repo.vendor_code + "</div></div>";
                return markup;
            }
    
            function formatVendorSelection(repo) {
                return repo.vendor_code || repo.text;
            }
    
            $("#bank_code").select2({
                placeholder: "Nhập bank name",
                allowClear: true,
                ajax: {
            ...
            function formatBank(repo) {
                ...
                var markup = "<div class='select2-result-repository clearfix'>" +
                    "<div class='select2-result-repository__meta'>" +
                    "<div class='select2-result-repository__title'>" + repo.bank_name + "</div>";
                markup += "<div class='select2-result-repository__statistics'>" +
                    "<div class='select2-result-repository__forks'><i class='fa fa-flash'></i> " + repo.bank_code + "</div></div>";
                return markup;
            }
    
            function formatBankSelection(repo) {
                return repo.bank_code || repo.text;
            }
