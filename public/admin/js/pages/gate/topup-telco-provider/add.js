    ...
    727: function (e, t, r) {
        ...
        jQuery(document).ready((function () {
            ...
            $("#providerCode").select2({
                ...
                allowClear: true,
                ajax: {
                    url: "/topup-provider-configs/ajax/get-list-source",
                    dataType: 'json',
                    delay: 250,
            ...
            function formatPartner(repo) {
                ...
                var markup = "<div class='select2-result-repository clearfix'>" +
                    ...
                    "<div class='select2-result-repository__title'>" + repo.providerCode + "</div>";
                return markup;
            }
    
            function formatPartnerSelection(repo) {
                return repo.providerCode || repo.text;
            }
