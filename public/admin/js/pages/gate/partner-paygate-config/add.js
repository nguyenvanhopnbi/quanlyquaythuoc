! function (e) {
    ...
    727: function (e, t, r) {
            ...
            init: function () {
                ...
                n = $("#kt_add_form"), (i = new KTWizard("kt_add", {
                    ...
                    submitHandler: function (e) {}
                        ...
                        url: "/partner-paygate-config/add",
                        method: 'POST',
        ...
        jQuery(document).ready((function () {
            ...
            $("#atm_transaction_fee").select2({
                placeholder: "Nhập phí giao dịch nội địa",
                allowClear: true,
                ajax: {
            ...
            $("#cc_transaction_fee").select2({
                placeholder: "Nhập phí giao dịch quốc tế",
                allowClear: true,
                ajax: {
                    url: "source/ajax/get-list-source-amount",
                    dataType: 'json',
            ...
            $("#ewallet_transaction_fee").select2({
                placeholder: "Nhập phí giao dịch ewallet",
                allowClear: true,
                ajax: {
                    url: "source/ajax/get-list-source-amount",
                    dataType: 'json',
