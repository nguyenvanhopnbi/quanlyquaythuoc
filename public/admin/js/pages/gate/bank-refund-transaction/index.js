    ...
    703: function(t, e, a) {
        ...
        var n, o = (n = {
            data: {
                ...
                source: {
                    read: {
                        url: "/gate-bank-refund-transaction/ajax/get-list",
                        method: 'GET',
                        params: {
                            query : {
                                ...
                                refund_type: urlParams.get('refund_type'),
                                status: urlParams.get('refund_status'),
                                ...
                                has_refund: urlParams.get('has_refund'),
                            }
                        }
                    }
                },
            ...
            columns: [ {
                ...
                autoHide: !1,
                template: function(t) {
                    return `<a href="javascript:;" data-id="${t.refund_id}" class="btn-view-detail btn btn-sm btn-clean btn-icon btn-icon-sm" title="View details"><i class="
                    flaticon2-search-1"></i></a><a data-toggle="modal" data-target="#changeStatusModal" onclick='refundStatus("${t.refund_id}")' data-id="${t.refund_id}" id="refundID-${t.refund_id}" class="badge badge-primary text-light">Change</a>`;
                }
            }]
        }, {
            init: function() {
                    ...
                    function() {
                        ...
                        function getDetailPartnerById(id)
                        {
                            if ($('#bankTransactionId'+id).length === 0){
                                $.ajax({
                                    type: "get",
                                    url: "/gate-bank-refund-transaction/detail/"+ id,
        ...
        jQuery(document).ready((function() {
            ...
            function exportTransaction()
            {
                $('#exportTransaction').click(function(e){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/gate-bank-refund-transaction/export",
                        data: {
                            query : {
                        ...
                        success: function (response) {
                            location.href = '/gate-bank-transaction/download?file='+response.path;
