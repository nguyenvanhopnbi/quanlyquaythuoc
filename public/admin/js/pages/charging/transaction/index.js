    ...
    703: function(t, e, a) {
        ...
        var n, o = (n = {
            data: {
                ...
                source: {
                    read: {
                        url: "/charging-card-transactions/ajax/get-list",
                        method: 'GET',
                        params:{
                            query: {
                                transaction_id: urlParams.get('transaction_id'),
                                partner_transaction_id: urlParams.get('partner_transaction_id'),
                    ...
                    function() {
                        ...
                        t.on('kt-datatable--on-layout-updated', function(){
                            $('.btn-view-detail').click(function(){
                                ...
                                getDetailChargingById(transactionId)
                            })
                        })
                        ...
                        function getDetailChargingById(id)
                        {
                            if ($('#chargingId'+id).length === 0){
                                $.ajax({
                                    type: "get",
                                    url: "/charging-card-transactions/detail/"+ id,
        ...
        jQuery(document).ready((function() {
            ...
            function exportTransaction()
            {
                $('#exportTransaction').click(function(e){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/charging-card-transactions/export",
                        data: {
                            query: {
                                transaction_id: urlParams.get('transaction_id'),
                                partner_transaction_id: urlParams.get('partner_transaction_id'),
                        ...
                        success: function (response) {
                            location.href = '/charging-card-transactions/download?file='+response.path;
