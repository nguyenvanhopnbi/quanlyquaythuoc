...
var KTDashboard = function() {
    ...
    function getFlashReport(){
        $.ajax({
            type: "POST",
            url: "/charging-card-transactions/get-flash-report",
            data: {partner_code: $("#partner_code_flash").val(), 'time-from': $('#time-from-flash').val(), 'time-to': $('#time-to-flash').val()},
    ...
    var buildChart = function() {
        ...
        $.ajax({
            type: "POST",
            url: "/charging-card-transactions/get-chart-transaction",
