...
class PartnerVendorService
{
    ...
    public function getList(array $params)
    {
        ...
        $data = PartnerVendorConnection::getList($params);
    ...
    {
        return PartnerVendorConnection::add($params);
    }

    public function edit(int $id, array $params)
    {
        return PartnerVendorConnection::edit($id, $params);
    }
    ...
    {
        return PartnerVendorConnection::detail($id);
    }
    ...
    {
        return PartnerVendorConnection::delete($id);
    }
}
