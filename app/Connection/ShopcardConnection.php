...
class ShopcardConnection
{
    public static function getList(array $params)
    {
        $url = env('API_URL_EBILL_SERVICE') . '/api/cms/service/shopcard/card';
    ...
    {
        $url = env('API_URL_EBILL_SERVICE') . '/api/cms/service/shopcard/card/delete';
        $params = [
            'id'=> $id
        ];
    ...
    {
        $url = env('API_URL_EBILL_SERVICE') . '/api/cms/service/shopcard/card/create';
        $result = Connection::sendRequest($url, $params, 'POST', AuthenticationHelper::getHeader());
        $resultBody = json_decode($result['body']);
    ...
    {
        $url = env('API_URL_EBILL_SERVICE') . '/api/cms/service/shopcard/card/update/'.$id;
        $result = Connection::sendRequest($url, $params, 'POST', AuthenticationHelper::getHeader());
        $resultBody = json_decode($result['body']);
