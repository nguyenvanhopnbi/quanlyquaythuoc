...
class partnerBusinessConnection
{
    public static function getList(array $params)
    {
        $url = env('API_URL_GATE_SERVICE') . '/api/v1/partner-business';
    ...
    {
        $url = env('API_URL_GATE_SERVICE') . '/api/v1/partner-business/create';
    ...
    {
        $url = env('API_URL_GATE_SERVICE') . '/api/v1/partner-business/delete';
        $params = [
            'id'=> $id
        ];
        $result = Connection::sendRequest($url, $params, 'POST', AuthenticationHelper::getHeader());
    ...
    {
        $url = env('API_URL_GATE_SERVICE') . '/api/v1/partner-business/update';
        $params['id'] = $id;
        $result = Connection::sendRequest($url, $params, 'POST', AuthenticationHelper::getHeader());
        $resultBody = json_decode($result['body']);
        if ($result['status_code'] != 200) {
