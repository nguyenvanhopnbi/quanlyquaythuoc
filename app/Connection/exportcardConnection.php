...
class exportcardConnection
{
    public static function exportcard(array $params)
    {
        $url = env('API_URL_EBILL_SERVICE') . '/api/cms/service/shopcard/card_item/export';
    ...
    {
        $url = env('API_URL_EBILL_SERVICE') . '/api/cms/service/shopcard/log_export';
