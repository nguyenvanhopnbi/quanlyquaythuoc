...
<div class="kt-grid kt-grid--ver kt-grid--root">
    <div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v3" style="background-image: url(assets/media/error/bg3.jpg);">
        <div class="kt-error_container">
            ...
            <a href="/" class="kt-error_title kt-font-light">
                Quay về trang chủ
            </a>
...
<script src="assets/plugins/global/plugins.bundle.js" type="text/javascript" defer></script>
<script src="assets/js/scripts.bundle.js" type="text/javascript" defer></script>
