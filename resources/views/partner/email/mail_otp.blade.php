...
{{--        <img src="{{asset('assets/media/logos/logo_pay.png')}}" title="Appota logo" class="logo"/>--}}
        ...
        <div class="my2"></div>
        <p>{{\Auth::user()->name}} yêu cầu xác nhận chi tiền kỳ đối soát {{$bbds_id}} cho đối tác {{$partner_name}}</p>
        ...
        <div class="my1 hr"></div>
        <div class="txtGrey my1">Mã xác thực cho lệnh chuyển tiền này là:</div>
        <div class="my1">
            <div
            ...
            <p style="margin-bottom: 10px">Click vào link để nhập OTP xác nhận yêu cầu.</p>
            <p style="margin-bottom: 10px"><a href="{{$link}}">{{$link}}</a></p>
        </div>
        <div class="my1 hr"></div>

        <div class="thankyou">
            <p class="txtGrey" style="font-size: 12px">Mã xác thực có hiệu lực trong vòng 60 phút</p>
        </div>
    </div>
</div>
</body>
