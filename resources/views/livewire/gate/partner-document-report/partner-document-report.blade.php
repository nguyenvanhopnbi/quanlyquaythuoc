                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                        <div class="form__group kt-form__group--inline">
                                            ...
                                            <a
                                            wire:click.prevent="$emit('searchPartnerDocumentReportScript')"
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Partner Document Report</h5>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">Sum document: </label>
                        <input type="text" class="form-control" id="sumDocument" placeholder="enter sum document">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Sum document miss: </label>
                        <input type="text" class="form-control" id="sumDocumentMiss" placeholder="enter sum document miss">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Day: </label>
                        <input type="text" class="form-control" id="addnewDay" placeholder="enter day">
                      </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">Sum document: </label>
                        <input type="text" class="form-control" id="UpdatesumDocument" placeholder="enter sum document">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Sum document miss: </label>
                        <input type="text" class="form-control" id="UpdatesumDocumentMiss" placeholder="enter sum document miss">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Day: </label>
                        <input type="text" class="form-control" id="updateDay" placeholder="enter day">
                      </div>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button wire:click.prevent="$emit('UpdatePartnerDocumentReportScript')" type="button" class="btn btn-primary">Save</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <table class="table table-light">
                <thead>
                    <tr>
                        ...
                        <th>Update at</th>
                        <th>Day</th>
                        <th>Sum document miss</th>
                        <th>Sum docuent</th>
                        <th>Ratio Document Miss</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    @if(isset($listPartnerDocumentReport))
                    @foreach($listPartnerDocumentReport as $list)
                    <tr>
                        <td><input id="IDPartnerDocumentReport-{{$list->id}}" type="hidden" value="{{$list->id}}">{{$list->id}}</td>
                        ...
                        <td><input id="updated_at-{{$list->id}}" type="hidden" value="{{$list->updated_at}}">{{date('Y-m-d H:i:s', $list->updated_at)}}</td>

                        <td><input id="day-{{$list->id}}" type="hidden" value="{{date('Y-m-d H:i:s', $list->day)}}">{{date('Y-m-d H:i:s', $list->day)}}</td>

                        <td><input id="sum_document_miss-{{$list->id}}" type="hidden" value="{{$list->sum_document_miss}}">{{$list->sum_document_miss}}</td>

                        <td><input id="sum_document-{{$list->id}}" type="hidden" value="{{$list->sum_document}}">{{$list->sum_document}}</td>

                        <td><input id="ratio_document_miss-{{$list->id}}" type="hidden" value="{{$list->ratio_document_miss}}">{{$list->ratio_document_miss}}</td>

                        <td style="width:100px">
                            <a data-placement="top" title="Update Partner Document Report" wire:click.prevent="$emit('getDateTablePartnerDocumentReportScript', '{{$list->id}}')" data-toggle="modal" data-target="#UpdatePartnerDocumentReport">
                                <i class="flaticon2-pen"></i> |
                            </a>
                            <a data-placement="top" title="Delete This Partner Document Report" wire:click.prevent="$emit('deletePartnerDocumentReportScript', '{{$list->id}}')">
