    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                        <div class="form__group kt-form__group--inline">
                                            ...
                                            <a
                                            wire:click.prevent="$emit('searchPartnerBusinessScript')"
                                            class="btn btn-primary"
                                            style="color:#FFF">Search</a>

                                            <a type="button" style="color: #FFF;" class="btn btn-primary" data-toggle="modal" data-target="#addNewPartnerBusiness"> Add new </a>
            ...
            {{-- end search form --}}
             ...
             {{-- add new form --}}
            <div wire:ignore.self class="modal fade" id="addNewPartnerBusiness" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Partner Business</h5>
                  ...
                  <div class="modal-footer">
                    ...
                    <button wire:click.prevent="$emit('savePartnerBusinessScript')" type="button" class="btn btn-primary">Save</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">Point: </label>
                        <input type="hidden" value="{{$partnerBusinessID}}" id="IDPartnerBusiness">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button wire:click.prevent="$emit('UpdatePartnerBusinessScript')" type="button" class="btn btn-primary">Save</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <table class="table table-light">
                ...
                <tbody>
                    @if(isset($listPartnerBusiness))
                    @foreach($listPartnerBusiness as $list)
                    <tr>
                        <td><input id="PartnerBusinessID-{{$list->id}}" type="hidden" value="{{$list->id}}">{{$list->id}}</td>
                        ...
                        <td><input id="UpdateAt-{{$list->id}}" type="hidden" value="$list->updated_at">{{date('Y-m-d H:i:s', $list->updated_at)}}</td>
                        <td style="width: 100px;">

                            <a data-placement="top" title="Update Partner Business" wire:click.prevent="$emit('getDateTablePartnerBusinessScript', '{{$list->id}}')" data-toggle="modal" data-target="#UpdatePartnerBusiness">
                                <i class="flaticon2-pen"></i> |
                            </a>
                            <a data-placement="top" title="Delete Partner Business" wire:click.prevent="$emit('deletePartnerBusinessScript', '{{$list->id}}')">
