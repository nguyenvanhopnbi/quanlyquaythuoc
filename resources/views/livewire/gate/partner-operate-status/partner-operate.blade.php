    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                        <div class="form__group kt-form__group--inline">
                                            ...
                                            <a
                                            wire:click.prevent="$emit('searchPartnerOperateScript')"
                                            class="btn btn-primary"
                                            style="color:#FFF">Search</a>

                                            <a type="button" style="color: #FFF;" class="btn btn-primary" data-toggle="modal" data-target="#addNewPartnerOperateStatus"> Add new </a>
            ...
            {{-- end search form --}}
             ...
             {{-- add new form --}}
            <div wire:ignore.self class="modal fade" id="addNewPartnerOperateStatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Partner Operate Status</h5>
                  ...
                  <div class="modal-footer">
                    ...
                    <button wire:click.prevent="$emit('savePartnerOperateStatusScript')" type="button" class="btn btn-primary">Save</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            {{-- update form --}}
            <div wire:ignore.self class="modal fade" id="UpdatePartnerOperateStatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button wire:click.prevent="$emit('UpdatePartnerOperateStatusScript')" type="button" class="btn btn-primary">Save</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <table class="table table-light">
                ...
                <tbody>
                    @if(isset($listPartnerOperate))
                    @foreach($listPartnerOperate as $list)
                    <tr>
                        <td><input id="IDPartner-{{$list->id}}" type="hidden" value="{{$list->id}}">{{$list->id}}</td>
                        ...
                        <td style="width:100px">
                            ...
                            <a data-placement="top" title="Update Partner Operate Status" wire:click.prevent="$emit('getDateTablePartnerCooperateScript', '{{$list->id}}')" data-toggle="modal" data-target="#UpdatePartnerOperateStatus">
                                <i class="flaticon2-pen"></i> |
                            </a>
                            <a data-placement="top" title="Delete Partner Operate Status" wire:click.prevent="$emit('deletePartnerOperateStatusScript', '{{$list->id}}')">
