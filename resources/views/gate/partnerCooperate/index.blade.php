@extends('index')
@section('page-header', 'Partner Cooperate')
@section('page-sub-header', 'Partner Cooperate')
@section('style')
...
@endsection
@section('content')
@livewire('gate.partner-cooperate.partner-cooperate')
@endsection
...
<script src="{{asset('js/partnerCooperate.js')}}"></script>
