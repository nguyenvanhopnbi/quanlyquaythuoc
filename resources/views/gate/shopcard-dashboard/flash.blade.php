<table class="table table-border">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="kt-datatable__cell; text-center"><div class="kt-user-card-v2__details">{{isset($partner->total_transaction) ? number_format($partner->total_transaction, 0, ',', '.') : 0 }}</div></td>
            <td class="kt-datatable__cell; text-center"><div class="kt-user-card-v2__details">{{isset($partner->total_amount) ? number_format($partner->total_amount, 0, ',', '.') : 0 }}</div></td>
        </tr>
        @empty
        <tr>
