                        ...
                        <div class="kt-portlet">
                            ...
                            <div class="kt-form">
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        <label for="providerName" class="col-12 col-lg-12 col-xl-3 col-form-label">Provider name <span class="kt-font-danger"><i class="fa fa-xs fa-star"></i></span></label>
                                        <div class="col-12 col-lg-12 col-xl-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <textarea class="form-control" type="text" value="" id="rsaPublicKey" rows="10" name="rsaPublicKey"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <textarea class="form-control" type="text" value="" id="rsaPrivateKey" rows="10" name="rsaPrivateKey"></textarea>
                                        </div>
                                    </div>
...
@section('script')
    ...
    <script src="admin/js/pages/gate/transfer-money-provider/add.js" type="text/javascript" defer></script>
@endsection
