@extends('index')
@section('page-header', 'Gate application')
@section('page-sub_header', 'Thêm mới gate application')
@section('style')
                            ...
                            <div class="kt-form">
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <input class="form-control" type="text" value="" id="icon" name="icon" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8 col-lg-8 col-xl-8">
                                            <input class="form-control" type="text" value="" id="api_key" name="api_key">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8 col-lg-8 col-xl-8">
                                            <input class="form-control" type="text" value="" id="secret_key" name="secret_key">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="providerCode" class="col-12 col-lg-12 col-xl-3 col-form-label">Allowed ips</label>
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <input class="form-control" type="text" value="" id="allowed_ips" name="allowed_ips">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="providerCode" class="col-12 col-lg-12 col-xl-3 col-form-label">Ebill notify url</label>
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <input class="form-control" type="text" value="" id="ebill_notify_url" name="ebill_notify_url" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="providerCode" class="col-12 col-lg-12 col-xl-3 col-form-label">Rsa public key</label>
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <textarea class="form-control" type="text" value="" id="rsa_public_key" name="rsa_public_key" ></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="providerCode" class="col-12 col-lg-12 col-xl-3 col-form-label">Rsa private key</label>
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <textarea class="form-control" type="text" value="" id="rsa_private_key" name="rsa_private_key" ></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <textarea class="form-control" type="text" value="" id="description" name="description" ></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script src="admin/js/pages/gate/application/add_provider.js" type="text/javascript" defer></script>
@endsection
