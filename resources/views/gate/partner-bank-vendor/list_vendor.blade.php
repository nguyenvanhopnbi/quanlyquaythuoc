...
@section('page-sub-header', 'Danh sách partner bank vendor')
@section('style')
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Danh sách partner bank vendor
                </h3>
            </div>
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="dropdown dropdown-inline">
                        <a href="/gate-partner-bank-vendor/add" class="btn btn-brand btn-icon-sm"><i class="flaticon2-plus"></i> Thêm partner bank vendor</a>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script src="admin/js/pages/gate/partner-bank-vendor/index.js" type="text/javascript" defer></script>
@endsection
