@extends('index')
@section('page-header', 'Partner Operate Status')
@section('page-sub-header', 'Partner Operate Status')
@section('style')
...
@endsection
@section('content')
@livewire('gate.partner-operate-status.partner-operate')
@endsection
...
<script src="{{asset('js/partnerOperateStatus.js')}}"></script>
