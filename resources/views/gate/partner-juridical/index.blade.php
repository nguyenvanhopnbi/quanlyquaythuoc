@extends('index')
@section('page-header', 'Partner Juridical')
@section('page-sub-header', 'Partner Juridical')
@section('style')
...
@endsection
@section('content')
@livewire('gate.partner-juridical.partner-juridical')
@endsection
...
<script src="{{asset('js/partnerJuridical.js')}}"></script>
