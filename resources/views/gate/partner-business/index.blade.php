@extends('index')
@section('page-header', 'Partner Business')
@section('page-sub-header', 'Partner Business')
@section('style')
...
@endsection
@section('content')
@livewire('gate.partner-business.partner-business')
@endsection
...
<script src="{{asset('js/partnerBusiness.js')}}"></script>
