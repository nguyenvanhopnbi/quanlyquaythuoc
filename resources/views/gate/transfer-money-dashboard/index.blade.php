@extends('index')
@section('page-header', 'Dashboard Transfer Money')
@section('page-sub-header', 'Dashboard Transfer Money')
@section('style')
...
@section('script')
    ...
    <script src="admin/js/pages/gate/transfer-money-dashboard/index.js" type="text/javascript" defer></script>
@endsection
