...
@section('page-sub_header', 'Thêm mới cấu hình vendor theo partner')
@section('style')
            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Thêm mới cấu hình vendor theo partner</h3>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script src="admin/js/pages/gate/partner-vendor/add.js" type="text/javascript" defer></script>
@endsection
