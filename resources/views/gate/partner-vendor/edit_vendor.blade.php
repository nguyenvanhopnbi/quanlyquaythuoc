...
@section('page-sub_header', 'Cập nhập cấu hình vendor theo partner')
@section('style')
            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Cập nhập cấu hình vendor theo partner </h3>
                </div>
            </div>
        </div>
...
@endsection
<script>
    var partnerCode = "{{$detail->partner_code}}";
    var vendorCode = "{{$detail->vendor_code}}";
</script>
@section('script')
    <script src="admin/js/pages/gate/partner-vendor/edit.js" type="text/javascript" defer></script>
@endsection
