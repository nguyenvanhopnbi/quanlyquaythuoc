@extends('index')
@section('page-header', 'Shopcard card discount config')
@section('page-sub_header', 'Thêm mới card discount config')
@section('style')
            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Thêm mới card discount config</h3>
                </div>
            </div>
        </div>
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    @foreach($cards as $vendor => $card)
                                        <div class="row">
                                            ...
                                            <div><h6 class="font-size-lg mb-6 btn-hide hide-vendor-{{$vendor}}" data-vendor="{{$vendor}}" style="display:none;cursor: pointer">Ẩn<h6></div>
                                            <div><h6 class="font-size-lg mb-6 btn-show show-vendor-{{$vendor}}" data-vendor="{{$vendor}}" style="cursor: pointer">Hiện<h6></div>
                                        </div>
                                        <div class="form-group row row-vendor-{{$vendor}}" style="display:none">
                                        ...
                                        <div class="form-group row row-vendor-{{$vendor}}" style="display:none">
                                            ...
                                            <div class="col-4 col-lg-4 col-xl-4">
                                                <input class="form-control" type="number" id="{{$c->product_code}}" name="{{$c->product_code}}">
                                            </div>
                                        </div>
                                        @endforeach
                                    @endforeach
...
@endsection
@section('script')
    <script src="admin/js/pages/gate/shop-card-discount-config/add.js" type="text/javascript" defer></script>
