            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="dropdown dropdown-inline">
                        <a href="/shopcard-card-discount-configs/add" class="btn btn-brand btn-icon-sm"><i class="flaticon2-plus"></i> Thêm mới tỉ lệ chiết khấu</a>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script src="admin/js/pages/gate/shop-card-discount-config/index.js" type="text/javascript" defer></script>
@endsection
