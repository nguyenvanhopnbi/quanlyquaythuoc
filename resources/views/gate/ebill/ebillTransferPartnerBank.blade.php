@extends('index')
@section('page-header', 'Transfer Partner Bank Provider')
@section('page-sub-header', 'Transfer Partner Bank Provider')
@section('style')
...
@endsection
@section('content')
@livewire('gate.ebill.ebilltransfer-partner-bank')
@endsection
