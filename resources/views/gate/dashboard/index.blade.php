@extends('index')
@section('page-header', 'Dashboard Dịch Vụ Cổng Thanh Toán')
@section('page-sub-header', 'Dashboard Dịch Vụ Cổng Thanh Toán')
@section('style')
	...
	<div class="col-xl-12">
		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						Thống kê theo nhà cung cấp và theo ngân hàng
					</h3>
				</div>
			</div>
			<div class="kt-portlet__body">
						...
						<form name="form-filter-transaction">
							<div class="row">
								<div class="col col-lg-3 col-xl-3">
									<label>Partner code</label>
									<select  class="form-control" type="text" name="partner_code2" id="partner_code2"></select>
								</div>
								<div class="col col-lg-3 col-xl-2">
									<label>Nhà cung cấp</label>
									<select  class="form-control" type="text" name="vendor_code" id="vendor_code"></select>
								</div>
								<div class="col col-lg-3 col-xl-2">
									<label>Ngân hàng</label>
									<select  class="form-control" type="text" name="bank_code" id="bank_code"></select>
								</div>
								<div class="col col-lg-3 col-xl-2">
									<label for="exampleInputPassword1">Từ ngày (tháng/ngày/năm)</label>
								<!-- <input type="date" name="time-from" id="time-from-flash" value="{{ date('Y-m-d') }}" class="form-control"> -->
									<input type="text" name="time-from2" id="time-from-flash2"  value="{{ date('m/d/Y') }}"  class="form-control">
								</div>
								<div class="col col-lg-3 col-xl-2">
									<label for="exampleInputPassword1">Đến ngày (tháng/ngày/năm)</label>
								<!-- <input type="date" name="time-to" id="time-to-flash" value="{{ date('Y-m-d') }}" class="form-control"> -->
									<input type="text" name="time-to2" id="time-to-flash2"   value="{{ date('m/d/Y') }}" class="form-control">
								</div>
								<div class="col col-lg-3 col-xl-2" style="padding-top:25px;">
									<button class="btn btn-primary btn-get-flash-chart2">Tìm kiếm</button>
				...
				<div id="table_flash_report_holder2">
...
@section('script')
    ...
    <script src="admin/js/pages/gate/dashboard/index.js?v={{ time() }}" type="text/javascript" defer></script>
@endsection
