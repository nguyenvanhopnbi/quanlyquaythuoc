@extends('index')
@section('page-header', 'Config Ebill Partner Provider')
@section('page-sub-header', 'Config Ebill Partner Provider')
@section('style')
...
@endsection
@section('content')
<livewire:ebill-config.ebill-config-partner-provider />
@endsection
