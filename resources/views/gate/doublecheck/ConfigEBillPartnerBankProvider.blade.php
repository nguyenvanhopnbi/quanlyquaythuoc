@extends('index')
@section('page-header', 'Config Bank Partner Provider')
@section('page-sub-header', 'Config Bank Partner Provider')
@section('style')
...
@endsection
@section('content')
<livewire:ebill-config.ebill-config-bank-partner-provider />
@endsection
...
@section('scriptlivewire')
    <script src="{{asset('js/ebillConfigPartnerProvider.js?v=2')}}"></script>
