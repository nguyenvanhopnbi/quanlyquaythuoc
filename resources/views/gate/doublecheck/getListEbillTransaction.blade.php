@extends('index')
@section('page-header', 'List Ebill Transaction By Account')
@section('page-sub-header', 'List Ebill Transaction By Account')
@section('style')
...
@endsection
@section('content')
<livewire:list-ebill-transaction-by-account />
@endsection
...
@section('scriptlivewire')
    {{-- <script src="{{asset('js/requestMoneyBack.js?v=2')}}"></script> --}}
