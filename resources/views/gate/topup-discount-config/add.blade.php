...
@section('page-sub_header', 'Thêm mới topup discount config')
@section('style')
            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Thêm mới topup discount config</h3>
                </div>
            </div>
        </div>
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    @foreach($telco as $key => $telco)
                                        ...
                                        <div class="form-group row row-vendor-{{$telco['key']}}" style="display:none">
                                            ...
                                            <div class="col-6 col-lg-6 col-xl-6">
                                                <input class="form-control" type="number" id="{{$a['name']}}" name="{{$telco['key']}}[{{$a['key']}}]" value="0">
                                            </div>
                                        </div>
                                        @endforeach
                                    @endforeach
...
@endsection
@section('script')
    <script src="admin/js/pages/gate/topup-discount-config/add.js" type="text/javascript" defer></script>
