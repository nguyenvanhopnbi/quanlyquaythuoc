@extends('index')
@section('page-header', 'Cấu hình tỉ lệ chiết khấu')
@section('page-sub-header', 'Cấu hình tỉ lệ chiết khấu')
@section('style')
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Cấu Hình Tỉ Lệ Chiết Khấu
                </h3>
            </div>
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="dropdown dropdown-inline">
                        <a href="/topup-discount-config/add" class="btn btn-brand btn-icon-sm"><i class="flaticon2-plus"></i> Thêm topup discount config</a>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script src="admin/js/pages/gate/topup-discount-config/index.js" type="text/javascript" defer></script>
@endsection
