@extends('index')
@section('page-header', 'Danh sách giao dịch thu hộ qua cổng thanh toán')
@section('page-sub-header', 'Danh sách giao dịch thu hộ qua cổng thanh toán')
@section('style')
...
@endsection
@section('content')
@livewire('bank-transaction-cross-check')
@endsection
...
<script src="{{asset('js/banktransactionHold.js')}}"></script>
