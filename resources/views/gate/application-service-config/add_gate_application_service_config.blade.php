@extends('index')
@section('page-header', 'Gate application service config')
@section('page-sub_header', 'Thêm mới gate application service config')
@section('style')
            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Thêm mới gate application service config</h3>
                </div>
            </div>
        </div>
                                ...
                                <div class="kt-portlet__body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            {{csrf_field()}}
                                            <select class="form-control" type="text" value="" id="partner_code" name="partner_code">

                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="providerCode" class="col-12 col-lg-12 col-xl-3 col-form-label">Sản phẩm <span class="kt-font-danger"><i class="fa fa-xs fa-star"></i></span></label>
                                        <div class="col-12 col-lg-12 col-xl-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <input class="form-control" type="text" value="" id="service_name" name="service_name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <input class="form-control" type="text" value="" id="service_code" name="service_code">
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
@endsection
@section('script')
    <script src="admin/js/pages/gate/application-service-config/add.js" type="text/javascript" defer></script>
@endsection
