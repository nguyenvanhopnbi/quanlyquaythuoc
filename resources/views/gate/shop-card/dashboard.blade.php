@extends('index')
@section('page-header', 'Dashboard Shopcard')
@section('page-sub-header', 'Dashboard Shopcard')
@section('style')
...
@section('script')
    ...
    <script src="admin/js/pages/gate/shopcard-dashboard/index.js" type="text/javascript" defer></script>
@endsection
