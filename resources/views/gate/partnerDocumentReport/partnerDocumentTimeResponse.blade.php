@extends('index')
@section('page-header', 'Partner Document Time Response')
@section('page-sub-header', 'Partner Document Time Response')
@section('style')
...
@endsection
@section('content')
@livewire('gate.partner-document-report.partner-document-time-response')
@endsection
...
<script src="{{asset('js/partnerDocumentTimeResponseConnection.js')}}"></script>
