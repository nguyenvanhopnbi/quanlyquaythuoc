@extends('index')
@section('page-header', 'Partner Document Report')
@section('page-sub-header', 'Partner Document Report')
@section('style')
...
@endsection
@section('content')
@livewire('gate.partner-document-report.partner-document-report')
@endsection
