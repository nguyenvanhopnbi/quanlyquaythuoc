@extends('index')
@section('page-header', 'Topup telco provider')
@section('page-sub_header', 'Cập nhập topup telco provider')
@section('style')
            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Cập nhập topup telco provider</h3>
                </div>
            </div>
        </div>
                                ...
                                <div class="kt-portlet__body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            ...
                                            <input class="form-control" type="text" id="telco" name="telco" placeholder="" value="{{$detail->telco}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <input class="form-control" type="text" id="providerCode" name="providerCode" placeholder="" value="{{$detail->providerCode}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-9">
                                            <select class="form-control" id="telcoServiceType" name="telcoServiceType">
                                                <option value="prepaid" @if($detail->telco_service_type === 'prepaid') selected="true" @endif >prepaid</option>
                                                <option value="postpaid"  @if($detail->telco_service_type === 'postpaid') selected="true" @endif >postpaid</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
@endsection
@section('script')
    {{-- <script src="admin/js/pages/gate/topup-telco-provider/edit.js" type="text/javascript" defer></script> --}}
@endsection
