@extends('index')
@section('page-header', 'Dashboard Ebill')
@section('page-sub-header', 'Dashboard Ebill')
@section('style')
...
@section('script')
    ...
    <script src="admin/js/pages/gate/ebill-dashboard/index.js" type="text/javascript" defer></script>
@endsection
