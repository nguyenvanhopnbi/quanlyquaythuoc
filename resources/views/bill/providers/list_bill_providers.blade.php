...
@section('page-sub-header', 'Danh sách Bill Provider')
@section('style')
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="dropdown dropdown-inline">
                        <a href="/bill-providers/add" class="btn btn-brand btn-icon-sm"><i class="flaticon2-plus"></i> Thêm Bill Provider</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                        ...
                                        <div class="kt-input-icon kt-input-icon--left">
                                            <input type="text" class="form-control" placeholder="Vui lòng nhập từ khóa..." name="query[providerName]" value="{{ request()->input('query.providerName')}}">
...
@section('script')
    ...
    <script src="admin/js/pages/bill/provider/bill_providers.js?v1.1" type="text/javascript" defer></script>
@endsection
