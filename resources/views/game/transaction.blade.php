                            ...
                            <div class="col-xl-12 order-2 order-xl-1">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3 kt-margin-b-20-tablet-and-mobile form-group mb-0">
                                        ...
                                        <div class="kt-input-icon kt-input-icon--left">
                                            <input type="text" class="form-control" name="order_id" value="{{request()->input('order_id')}}"
                                    ...
                                    <div class="col-md-12 kt-margin-b-20-tablet-and-mobile form-group mb-0">
                                        <div class="form__group kt-form__group--inline">
                                            ...
                                            <a href="{{route('game.transaction')}}" class="btn btn-default float-right">Xoá bộ lọc</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script src="/admin/js/pages/game/game-transaction.js?v={{time()}}" type="text/javascript" defer></script>
