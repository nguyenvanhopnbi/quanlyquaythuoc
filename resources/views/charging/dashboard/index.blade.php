@extends('index')
@section('page-header', 'Dashboard appotacard')
@section('page-sub-header', 'Dashboard appotacard')
@section('style')
	...
	<div class="col-xl-12">
		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						Thống kê tổng tiền thẻ đã gạch
					</h3>
				</div>
			</div>
				...
				<div class="kt-portlet__body">
					...
					<div class="kt-section">
						...
						<div class="row" style="padding-top:1%;">
							<div class="col col-lg-3 col-xl-2">
								<label for="exampleInputPassword1"><b>Tổng số thẻ:</b></label>
...
<div class="col-xl-12">
		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						Thống kê thẻ đã gạch theo mệnh giá
					</h3>
				</div>
			</div>
			<div class="kt-portlet__head param-search-dash">
					...
					<div class="kt-section">
						...
						<form name="form-filter-transaction">
							<div class="row">
								<div class="col col-lg-2 col-xl-2">
									<label>Partner code</label>
									<select type="text" name="partner_code" id="partner_code_pie" class="form-control" aria-describedby="emailHelp" placeholder="Partner code"></select>
								</div>
								<!-- <div class="col col-lg-2 col-xl-2">
									<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
										<li class="nav-item">
											<a class="nav-link btn-search-day-pie active" data-toggle="tab" href="#" role="tab">
											Day
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link btn-search-month-pie" data-toggle="tab" href="#" role="tab">
											Month
											</a>
										</li>
									</ul>
								...
								<div class="col col-lg-3 col-xl-2">
									<label for="exampleInputPassword1">Từ ngày (tháng/ngày/năm)</label>
									<input type="input" name="time-from" value="{{ date('m/d/Y') }}" id="time-from_pie" class="form-control">
								</div>
								<div class="col col-lg-3 col-xl-2">
									<label for="exampleInputPassword1">Đến ngày (tháng/ngày/năm)</label>
									<input type="input" name="time-to" value="{{ date('m/d/Y') }}" id="time-to_pie" class="form-control" >
								</div>
								<div class="col col-lg-3 col-xl-2" style="padding-top:25px;">
									<button class="btn btn-primary btn-get-chart-pie">Tìm kiếm</button>
								</div>
							</div>
						</form>
						</div>
						...
						<div class="col col-lg-3 col-xl-3">
							<label for="exampleInputPassword1"><b>Tổng số thẻ:</b></label>
							<!-- <input type="text" class="form-control" value="0" id="count_transaction_pie" disabled="true"> -->
							<b><label  id="count_transaction_pie">0</label></b>

						</div>
						<div class="col col-lg-3 col-xl-3">
							<label for="exampleInputPassword1"><b>Tổng số tiền:</b></label>
							<!-- <input type="text" class="form-control" value="0" id="sum_transaction_pie" disabled="true"> -->
							<b><label  id="sum_transaction_pie">0</label></b>
			...
			<div class="kt-portlet__body holder-chart-pie">
				<canvas height="215" class="dash-board-pie chartjs-render-monitor dash-board-used-card"  style="width: 100%;"></canvas>
			</div>
		</div>
	</div>
</div>
...
@section('script')
    ...
    <script src="admin/js/pages/charging/dashboard/index.js" type="text/javascript" defer></script>
@endsection
